...
//go:generate go2cfg -type Nesting -out nesting.jsonc
//go:generate go2cfg -type Nesting -doc-types all -out nesting_all_fields.jsonc
//go:generate go2cfg -type Nesting -doc-types basic -out nesting_basic_fields.jsonc
